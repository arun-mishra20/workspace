...
import { RULE_DASHBOARD_REPOSITORY } from '@/modules/expenses/application/ports/rule-dashboard.repository.port'
...
import { RuleDashboardRepositoryImpl } from '@/modules/expenses/infrastructure/repositories/rule-dashboard.repository'
...
@Module({
  ...
  providers: [
    ...
    {
      provide: RULE_DASHBOARD_REPOSITORY,
      useClass: RuleDashboardRepositoryImpl,
    },
  ],
