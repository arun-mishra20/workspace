...
const ALL_NEUMORPHIC_OVERRIDES = [
  ...NEUMORPHIC_VARIABLES,
  ...NEUMORPHIC_SHADOW_OVERRIDES,
];
...
const NEUMORPHIC_PRESETS = [
  ...
  // Metallic Variants
  {
    ...
    colors: {
      ...
      shadowLight: "hsl(220, 20%, 90%)",
      shadowDark: "hsl(220, 18%, 55%)",
    },
  },
  {
    name: "Chrome",
    colors: {
      background: "hsl(215, 12%, 70%)",
      shadowLight: "hsl(215, 18%, 88%)",
      shadowDark: "hsl(215, 16%, 48%)",
    },
  },
  {
    name: "Platinum",
    colors: {
      background: "hsl(200, 10%, 78%)",
      shadowLight: "hsl(200, 14%, 92%)",
      shadowDark: "hsl(200, 12%, 58%)",
    },
  },
  {
    name: "Gold",
    colors: {
      background: "hsl(42, 55%, 68%)",
      shadowLight: "hsl(42, 65%, 85%)",
      shadowDark: "hsl(42, 50%, 45%)",
    },
  },
  {
    name: "Brass",
    colors: {
      background: "hsl(40, 45%, 58%)",
      shadowLight: "hsl(40, 55%, 75%)",
      shadowDark: "hsl(40, 42%, 36%)",
    },
  },
  {
    name: "Bronze",
    colors: {
      background: "hsl(30, 50%, 52%)",
      shadowLight: "hsl(30, 60%, 70%)",
      shadowDark: "hsl(30, 46%, 30%)",
    },
  },
  {
    name: "Copper",
    colors: {
      background: "hsl(20, 58%, 55%)",
      shadowLight: "hsl(20, 68%, 72%)",
      shadowDark: "hsl(20, 52%, 32%)",
    },
  },
  {
    name: "Rose Gold",
    colors: {
      background: "hsl(10, 48%, 70%)",
      shadowLight: "hsl(10, 58%, 86%)",
      shadowDark: "hsl(10, 44%, 48%)",
    },
  },
  {
    name: "Gunmetal",
    colors: {
      background: "hsl(200, 14%, 32%)",
      shadowLight: "hsl(200, 18%, 46%)",
      shadowDark: "hsl(200, 18%, 18%)",
    },
  },
  {
    name: "Titanium",
    colors: {
      background: "hsl(210, 8%, 42%)",
      shadowLight: "hsl(210, 12%, 58%)",
      shadowDark: "hsl(210, 10%, 26%)",
    },
  },
  {
    name: "Pewter",
    colors: {
      background: "hsl(215, 10%, 55%)",
      shadowLight: "hsl(215, 14%, 72%)",
      shadowDark: "hsl(215, 12%, 36%)",
    },
  },
  {
    name: "Iron",
    colors: {
      background: "hsl(220, 6%, 38%)",
      shadowLight: "hsl(220, 10%, 54%)",
      shadowDark: "hsl(220, 8%, 22%)",
    },
  },
];
...
export function NeumorphicPresets({ activeMode }: NeumorphicPresetsProps) {
  ...
  const [selectedPreset, setSelectedPreset] = useState<
    (typeof NEUMORPHIC_PRESETS)[number] | null
  >(null);
      ...
      <div>
        ...
        <div className="flex items-center justify-center p-8 bg-muted rounded-lg">
          <div
            ...
            style={{
              backgroundColor: (selectedPreset ?? NEUMORPHIC_PRESETS[0]).colors
                .background,
