...
export function AnalyticsContextBar({
  ...
  const spendExclusionControls = (
    <div className="flex items-center gap-1.5 rounded-full border border-dashed border-border bg-muted/60 px-3 py-1.5">
  ...
  if (activeTab === 'dashboards') {
    ...
    return (
      <div className="flex flex-col gap-3 rounded-[14px] border border-border bg-card px-4 py-3 sm:flex-row sm:flex-wrap sm:items-center">
  ...
  return (
    <div className="flex flex-col gap-3 rounded-[14px] border border-border bg-card px-4 py-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
      <div className="flex flex-wrap items-center gap-2.5">
        ...
        {selectedCard ? (
          <Badge
            variant="secondary"
            className="h-8 gap-1.5 pl-2.5 pr-1.5 text-xs"
          >
            {selectedCard.cardName} ••{selectedCard.cardLast4}
            <button
              type="button"
