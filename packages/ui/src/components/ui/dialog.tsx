...
const DialogContent = ({ ref, className, children, disableClose, ...props }: React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      onPointerDownOutside={(e) => {
        disableClose ? e.preventDefault() : null
      }}
      {...props}
    >
      {children}
